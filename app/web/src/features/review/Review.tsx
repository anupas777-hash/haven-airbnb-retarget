...
export function Review({ campaignId }: { campaignId: string }) {
  ...
  return (
    <div className="space-y-6 max-w-[760px] mx-auto">
      ...
      <p className="text-sm text-stone max-w-[560px]">Same ticket to your set - each stamped per guest. Sends are idempotent and throttled; failed can be retried.</p>
      ...
      <Card className="ticket-perf p-6 pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4 text-sm">
          ...
          <div className="bg-paper rounded-xl p-3 border border-fog">
            <div className="mono text-[11px] tracking-[0.08em] uppercase text-stone">Ticket</div>
      ...
      <Card className="overflow-hidden">
        <div className="p-4 border-b border-fog flex items-center justify-between bg-paper">
          ...
          <div className="flex items-center gap-2">
            <Badge className="mono text-[11px] border-fog bg-paper text-stone">{deliveries?.length || 0} tickets</Badge>
              ...
              {!deliveries?.length && (
                <tr>
                  <td colSpan={5} className="p-10 text-center mono text-sm text-stone">
                    No posts yet - set a ticket and post.
                  </td>
                </tr>
              )}
            </tbody>
